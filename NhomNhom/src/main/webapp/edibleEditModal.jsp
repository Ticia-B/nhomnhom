...
<div id="edibleEditModalOverlay"
     class="hidden fixed inset-0 bg-black bg-opacity-50 z-40 transition-opacity backdrop-blur-sm">

    <div id="edibleEditModal" class="hidden fixed inset-0 z-50 flex items-center justify-center p-4">
...
<script src="editEdibleModal.js"></script>