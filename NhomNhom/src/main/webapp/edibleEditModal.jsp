...
<div id="edibleEditModalOverlay"
     class="hidden fixed inset-0 bg-black bg-opacity-50 z-[60] transition-opacity">
</div>

<div id="edibleEditModal" class="hidden fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto transform transition-all scale-100 pointer-events-auto">
        ...
        <div class="bg-gradient-to-r from-amber-600 to-orange-300 p-6 rounded-t-2xl relative">
            ...
            <p class="text-yellow-50 mt-2">Altere as informações :3</p>
        </div>

        <form id="editEdibleForm" class="p-6 space-y-4" action="edible/update" method="post">
            <input type="hidden" name="edibleId" id="editEdibleIdInput">
            <div>
                <p class="text-xs text-gray-500 font-mono ml-2">ID do Produto: <span id="spanEdibleId"></span></p>
            </div>
