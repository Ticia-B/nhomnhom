                            ...
                            <div class="mt-auto flex items-center justify-between gap-3">
                                <div class="mt-auto flex items-center justify-center w-full gap-3">
                                    <div class="flex gap-2 items-center">
                                        <button class="px-6 py-4 bg-amber-500 hover:bg-yellow-800 text-white rounded-full shadow-md hover:shadow-lg transition-all flex items-center gap-1.5 text-sm"
