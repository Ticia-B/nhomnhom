...
<main class="pb-10 px-4 sm:px-6 relative z-10">
    ...
    <div id="showingProductsReal" class="${hasSearch ? 'hidden' : ''} max-w-7xl mx-auto bg-amber-50 rounded-3xl overflow-hidden min-h-[600px] -mt-12 shadow-xl border border-orange-100">
            ...
            <c:forEach var="e" items="${edibles}">
                <div class="edible-card group bg-orange-50 border border-orange-100 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col"
                    ...
                    <div class="relative h-48 overflow-hidden">
                        <img src="${e.ediblePhoto}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        ...
                        <div class="mt-auto flex items-center justify-between gap-3">
                            ...
                            <a href="cart?action=add&id=${e.edibleId}" class="px-4 py-2.5 bg-yellow-800 hover:bg-yellow-500 text-white rounded-full shadow-md hover:shadow-lg transition-all flex items-center gap-2">
    ...
    <div id="searchingProductsReal" class="${hasSearch ? '' : 'hidden'} max-w-7xl mx-auto bg-amber-50 rounded-3xl overflow-hidden min-h-[600px] -mt-12 shadow-xl border border-orange-100">
        ...
        <div class="p-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            <c:if test="${not empty sessionScope.searchEdibles}">
                <c:forEach var="e" items="${sessionScope.searchEdibles}">
                    <div class="group bg-orange-50 border border-orange-100 rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden flex flex-col">
